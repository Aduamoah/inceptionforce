              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 rounded-[24px] border py-16 px-8 bg-[#F9F9F9] items-center">
                <div className="flex flex-col gap-2">
                  ...
                  <p
                    ...
                    style={{ fontFamily: "Mosvita" }}
                  >
                    Keep track of perishable ingredients with automated alerts
                    for low stock and expiries. Ensure smooth kitchen operations
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[120px] p-10 bg-[#C6F6D6]">
              <div className="flex">
                <h4
                  ...
                  style={{ fontFamily: "Mosvita" }}
                >
                  Smarter stock control to keep your business running
                  seamlessly.
                </h4>
              </div>
