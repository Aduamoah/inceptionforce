...
const Footer: React.FC = () => {
  return (
    <div className="w-full h-auto py-[80px] flex flex-col justify-between px-6 md:px-12 lg:px-[120px]  bg-[#0D673B]">
      ...
      <div className="w-full flex flex-row items-start justify-between">
        <div className="w-[353.294px] h-auto">
          <div className="flex items-start gap-4">
            ...
            <p className="text-[#FFFFFF] ">Inception Force</p>
          </div>

          <div className="w-full h-auto flex flex-row gap-4 mt-4">
            <div className="w-[40px] min-h-[40px] flex items-center justify-center rounded-full bg-[#16B365]">
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
      ...
      <div className="w-full flex flex-row gap-6 items-start mt-4">
        <div className="w-[886px] border-t border-white"></div>
        <p className="font-normal text-[16px] leading-[20px] tracking-[-2%] text-center text-[#FFFFFF] mt-0">
