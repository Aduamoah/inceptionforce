...
"
          >
            {/* LEFT */}
            <div className=" w-full h-auto gap-10 flex flex-col order-2 md:order-1">
              <div className="h-auto flex flex-row gap-2.5">
                <svg
                  width="32"
                  height="32"
                  viewBox="0 0 32 32"
                ...
                <h5
                  className=" text-[31px] leading-[100%] font-semibold tracking-normal align-middle"
                  style={{ fontFamily: "Mosvita" }}
                >
                  Operational Core
                </h5>
              ...
              >
                ...
                operations smoothly — from stock control to sales and delivery.
                Whether you're running one outlet or a chain of businesses, you
                stay in control with real-time visibility and streamlined
                workflows.
              </p>
              ...
              >
                ...
                Track and manage stock levels, alerts, and movements across all
                locations.
              </p>
              ...
              <p
                ...
                style={{ fontFamily: "Mosvita" }}
              >
                <span className="font-bold ">Delivery Tracking:</span>
                Know exactly where every order stands with real-time updates.
              </p>
          ...
          <div className=" w-full  min-h-screen md:min-h-[373px] lg:min-h-[373px] grid grid-cols-1 md:grid-cols-2 gap-20 ">
            ...
            <div className="w-full h-auto flex flex-col gap-4">
              ...
              <p
                ...
                style={{ fontFamily: "Mosvita" }}
              >
                <span className="font-bold "> Sketchpad-to-Invoice Tool:</span>
              ...
              <button className="w-[149px] h-[40px] py-2 px-6 flex items-center justify-center gap-2 rounded bg-[#1CE783] rotate-0 opacity-100">
                <span>Start Free</span>
          ...
          <div className="h-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="h-auto flex flex-col gap-4 ">
              ...
              >
                ...
                Keep your team in sync with shared tasks, real-time updates, and
                centralized communication.
              </p>

              <div className="min-h-[40px] flex flex-row gap-6 rotate-0 opacity-100">
                {" "}
                <button className=" py-2 px-6 flex items-center justify-center gap-2 rounded bg-[#1CE783] rotate-0 opacity-100">
                  <span>Start Free</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="h-auto flex flex-col gap-4 ">
              ...
              >
                ...
                Accept orders, manage tables, and serve faster with a POS system
